...
public class ReadFile {
    ...
    private void load() throws FileNotFoundException {
        ...
        try {
            ...
            1967(Jan 15)|I|Green Bay Packers|35|Kansas City Chiefs|10|Bart Starr|Memorial Coliseum|Los Angeles|California

            Main text is split with "|" but to get the date you would have to split "(" and ")" from the first piece
